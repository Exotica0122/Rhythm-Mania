...
SceneCanonDEasy::SceneCanonDEasy()
	: m_pCursor(0)
...
bool
SceneCanonDEasy::Initialise(Renderer& renderer, FMOD::System* soundSystem)
{
	renderer.CreateStaticText("J. Pachelbel - Canon (Cranky Remix) (lcfc) [Easy]", 25);
	m_pDifficultyText = renderer.CreateSprite("J. Pachelbel - Canon (Cranky Remix) (lcfc) [Easy]");
	...
	m_pSongClass->Initialise(renderer, soundSystem, "songs\\847812 J Pachelbel - Canon (Cranky Remix)\\J. Pachelbel - Canon (Cranky Remix) (lcfc) [Easy].osu");
...
void
SceneCanonDEasy::Process(float deltaTime, InputSystem& inputSystem)
{
	// Implement UI stuffs
...
bool
SceneCanonDEasy::GetIsPaused()
{
	return m_bIsSongPause;
}

void
SceneCanonDEasy::DebugDraw()
{
...
void
SceneCanonDEasy::Draw(Renderer& renderer)
{
